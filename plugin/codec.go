...
type MessageCodec interface {
	...
	EncodeMessage(message interface{}) (data []byte, err error)
	// DecodeMessage decodes a slice of bytes to a message.
	DecodeMessage(data []byte) (message interface{}, err error)
}
...
type MethodCodec interface {
	...
	// DecodeMethodCal decodes the MethodCall form binary.
